...
var logoutSelect = function logoutSelect(req, res) {
  req.logout();
  res.redirect(_routes["default"].home);
};

exports.logoutSelect = logoutSelect;
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _User["default"].findByIdAndUpdate(req.user.id, {
              name: name,
              email: email,
              avatarUrl: file ? file.path : "/".concat(req.user.avatarUrl)
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            res.status(400).send("Verify new password");
